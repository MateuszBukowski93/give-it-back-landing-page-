    ...
    <section className="py-12 pb-24">
      <Container className="text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-lg mx-auto">
            {/* App Store Button */}
            <button className="flex-1 flex items-center justify-center gap-3 bg-[#0f1e16] hover:bg-[#162e22] text-white py-4 px-6 rounded-2xl border border-white/10 transition-colors shadow-lg group">
                ...
                <div className="text-left">
                    <div className="text-[10px] uppercase font-medium text-emerald-500">Pobierz w</div>
            ...
            <button className="flex-1 flex items-center justify-center gap-3 bg-[#0f1e16] hover:bg-[#162e22] text-white py-4 px-6 rounded-2xl border border-white/10 transition-colors shadow-lg group">
                ...
                <div className="text-left">
                    <div className="text-[10px] uppercase font-medium text-emerald-500">Pobierz z</div>
